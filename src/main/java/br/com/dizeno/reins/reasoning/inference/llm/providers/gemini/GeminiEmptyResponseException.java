...
public class GeminiEmptyResponseException extends LlmEmptyResponseException {
    ...
    /**
     * Constructs a new instance of {@link GeminiEmptyResponseException}.
     *
     ...
     */
    public GeminiEmptyResponseException(String message, int totalAttempts, int noUsableContentCount) {
        super(message);
